            ...
            <div class="sb2-1">
                ...
                <div class="sb2-12">
                    <ul>
                        ...
                        <li>
                            <h5>{{ Auth::user()->name }} <span> {{  Carbon\Carbon::now()->format('l, d-m-y') }}</span></h5>
                        </li>
                        <li></li>
                    </ul>
                </div>
                ...
                <div class="sb2-13">
                    <ul class="collapsible" data-collapsible="accordion">
                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-user" aria-hidden="true"></i> Vehicle</a>
